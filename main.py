...
def Var4Vec(input_tensor):
    Var = torch.var(input_tensor)
    return Var
...
#    torch.nn.utils.clip_grad_norm(model.parameters(), args.clip)
    ...
    # Add loss with various
    loss_train = loss(yf_pred[idx_train], YFtr) + alpha * dist + 0.01 * abs( Var4Vec( yf_pred[idx_train] ) - Var4Vec( YFtr ) )
